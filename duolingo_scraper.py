...
class Duolingo:
    ...
    def loginDuo(self, username, password):
        ...
        driver.find_element_by_xpath(
            "//*[@id='root']/div/div/span[1]/div/div[1]/div[2]/div[2]/a").click()
        time.sleep(1)

        # Insertinf credentials.
        driver.find_element_by_xpath(
            "/html/body/div[2]/div[5]/div/div/form/div[1]/div[1]/div[1]/label/div/input").send_keys(username)
        driver.find_element_by_xpath(
            "/html/body/div[2]/div[5]/div/div/form/div[1]/div[1]/div[2]/label/div[1]/input").send_keys(password)
        driver.find_element_by_xpath("/html/body/div[2]/div[5]/div/div/form/div[1]/button").click()
        time.sleep(5)
